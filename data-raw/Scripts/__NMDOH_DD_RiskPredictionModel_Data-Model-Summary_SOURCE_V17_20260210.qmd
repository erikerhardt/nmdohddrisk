...
params:
  ...
  working_directory   : PARAMS_working_directory  # set to FALSE if working_drive is short
  sw_Win_drive_subst  : PARAMS_sw_Win_drive_subst # set sw_Win_drive_subst to FALSE if working_drive is short
  sw_Win_path_to_subst: PARAMS_sw_Win_path_to_subst
...
#  path_prefix_out   : "out_V17"     # prefix for out folder and model output
...
#output-file: "NMDOH_DD_RiskPredictionModel_Data-Model-Summary_20240125__out_V17_2024_01_01_All.pdf"
...
# Step 2: copy/paste these commands to RStudio Console window
  ...
  fn_qmd <- "NMDOH_DD_RiskPredictionModel_Data-Model-Summary_V17_20260205.qmd"
  setwd("D:/Dropbox/StatAcumen/consult/Industry/2023_NM_DOH_DDWaiver/data/Ydrive/Risk_Prediction_Model/Scripts")
  fn_pdf <-
    paste0(
      fn_qmd
    , "__"
    , "out_V17"             # params$path_prefix_out
    , "_"
...
## Testing params
# params <- list()
# params$date_Current          = "2022-01-01"
# params$DD_Group              = "All"
# params$date_today            = "2026-02-10"
# params$path_prefix_out       = "out_V17"
# params$sw_read_data          = TRUE
# params$sw_run_model          = FALSE
# #params$working_directory     = "D:/Dropbox/StatAcumen/consult/Industry/2023_NM_DOH_DDWaiver/data/Ydrive/Risk_Prediction_Model/Scripts"
# params$working_directory     = "S:/Risk_Prediction_Model/Scripts"
# params$sw_Win_drive_subst    = "S:"    # set to FALSE if working_drive is short
# params$sw_Win_path_to_subst  = "D:/Dropbox/StatAcumen/consult/Industry/2023_NM_DOH_DDWaiver/data/Ydrive"
...
if (Sys.info()["sysname"] == "Windows" & !isFALSE(params$sw_Win_drive_subst)) {
  working_drive_win <-
    params$sw_Win_path_to_subst |>
...
* **Risk Prediction Model parameters**
    ...
    * `working_drive`       : `r params$working_drive      `
    * `sw_Win_drive_subst`  : `r params$sw_Win_drive_subst `
...
* Prediction results are in Folder:
    * `r file.path(params$working_drive, params$working_directory)`
* in File:
