...
date_Current        = "2022-01-01"
DD_Group            = "All"
date_today          = lubridate::today()
path_prefix_out     = "out_V17"
sw_read_data        = TRUE
sw_run_model        = TRUE
working_drive       = "D:/Dropbox/StatAcumen/consult/Industry/2023_NM_DOH_DDWaiver/data/Ydrive"
sw_Win_drive_subst  = "S:"    # set to FALSE if working_drive is short
working_directory   = "Risk_Prediction_Model/Scripts"
...
setwd(file.path(working_drive, working_directory))

# filenames
fn_root <-
  "NMDOH_DD_RiskPredictionModel_Data-Model-Summary"
fn_in_qmd <-
  paste0("__", fn_root, "_SOURCE_V17_20260205.qmd")
fn_out <-
...
PARAMS <-
  ...
  , PARAMS_working_drive      = working_drive
