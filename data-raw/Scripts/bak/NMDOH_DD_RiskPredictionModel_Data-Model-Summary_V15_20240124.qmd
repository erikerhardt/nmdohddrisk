...
params:
  ...
  date_today        : "2024-01-16" # determines name of dat_ and out_ folders for results
  date_Current      : "2024-01-01" # determines last date in data for analysis
  path_prefix_out   : "out_V15"    # prefix for out folder and model output
  ...
  working_directory : "D:/Dropbox/StatAcumen/consult/Industry/2023_NM_DOH_DDWaiver/data/Zdrive/Risk_Prediction_Model/Scripts"  # Should be detailed path to "Risk_Prediction_Model/Scripts"
output-file: "NMDOH_DD_RiskPredictionModel_Data-Model-Summary_20240116__out_V15_2024_01_01_All.pdf"
#
#
# ===========================================================================
...
# Step 2: copy/paste these commands to RStudio Console window
  ...
  fn_qmd <- "NMDOH_DD_RiskPredictionModel_Data-Model-Summary_20240115.qmd"
  setwd("D:/Dropbox/StatAcumen/consult/Industry/2023_NM_DOH_DDWaiver/data/Zdrive/Risk_Prediction_Model/Scripts")
  fn_pdf <-
    paste0(
      "NMDOH_DD_RiskPredictionModel_Data-Model-Summary_20240115_"
    , "_"
    , "out_V15"             # params$path_prefix_out
    , "_"
    , "2023_12_01"          # params$date_Current
    , "_"
    , "All"                 # params$DD_Group
    ,".pdf"
    )
...
# params$date_today         = "2024-01-15" # determines name of dat_ and out_ folder for results
# params$date_Current       = "2023-12-01" # determines last date in data for analysis
# params$path_prefix_out    = "out_V15"
