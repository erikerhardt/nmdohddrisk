---
# NMDOH Data Team, set these parameters
params:
  DD_Group         : "All"        # c("All", "DD", "MV", "MF")[1]
  date_today       : "2024-01-15" # determines name of dat_ and out_ folder for results
  date_Current     : "2023-12-01" # determines last date in data for analysis
  path_prefix_out  : "out_V15"
...
subtitle:     "Read and format data, Run Model, Additional summaries"
...
#for (i_group in params$do_groups) {
  ## i_group = 1
